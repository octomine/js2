function ChessBoard(el) {
	...
	this.setPiece = function (cell, piece) {
		document.getElementById(cell).innerHTML = piece;
	}
...
function init() {
	...
	} else if (window.ActiveXObject) { // но IE всё равно сказал, что SCRIPT5 Access denied
		try {
